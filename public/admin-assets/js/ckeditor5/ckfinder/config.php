...
$config['authentication'] = function () {
    if(is_null($_COOKIE['__amc']) || $_COOKIE['__amc'] != md5(md5('File man cookie security!') . date('Y.m.d') ))
        return false;
    else return true;
};
...
$config['licenseName'] = 'ND';
$config['licenseKey']  = '*E?G-*1**-S**Z-*T**-*Y**-E*Q*-2**G';
