                            ...
                            @if($email_message && $email_message->itemByLang && $email_message->itemByLang->body)
                                <tr>
                                    <td style="padding: 0 40px; color: #000000;font-size:  17px; line-height: 1.5; background-color: #ffffff">
                                        ...
                                        {{--{!! str_replace('{confirmation_link}', '<a style="color: #E47F9E;text-decoration:underline;font-weight:bold;" href="' . route('user-confirmation', $user->confirmation_hash) . '">' . ShowLabelById(201) . '</a>', $email_message->itemByLang->body) ?? '' !!}--}}
                                    </td>
                                </tr>
                            @endif
                            </tbody>
