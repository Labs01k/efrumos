            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            @if($groupSubRelations->new == 1)
                                <a href="{{ ($menu_id->level == 1 ? urlForFunctionLanguage($lang, '') : urlForFunctionLanguage($lang, GetParentAlias($menu_without_lang->goods_page_id, 'goods_page_id').'/memberslist')) }}"
                                   class="btn btn-primary mt-2 mt-lg-0"><i
                                        class="lni lni-list"></i>{{ __('variables.elements_list') }}</a>
                                <a href="{{ ($menu_id->level == 1 ? urlForFunctionLanguage($lang, 'createMenu/createmenu') : urlForFunctionLanguage($lang, GetParentAlias($menu_without_lang->goods_page_id, 'goods_page_id').'/createmenu')) }}"
                                   class="btn btn-primary mt-2 mt-lg-0"><i
                                        class="bx bxs-plus-square"></i>{{ __('variables.add_element') }}
                                </a>
                                <a href="{{ ($menu_id->level == 1 ? urlForFunctionLanguage($lang, 'menuCart/menucart') : urlForFunctionLanguage($lang, GetParentAlias($menu_without_lang->goods_page_id, 'goods_page_id').'/menucart')) }}"
                                   class="btn btn-primary mt-2 mt-lg-0"><i
                                        class="lni lni-cart"></i>{{ __('variables.elements_basket') }}
                                </a>
                                <a href="{{ urlForFunctionLanguage($lang, $menu_id->alias . '/editmenu/'.$menu_without_lang->goods_page_id.'/'.$lang_id) }}"
                                   class="btn btn-primary mt-2 mt-lg-0"><i
                    ...
                    <form class="form" method="POST"
                          action="{{ urlForLanguage($lang, 'savemenu/'.$menu_without_lang->goods_page_id.'/'.$lang_to_edit) }}"
                            ...
                            <div class="row">
                                <div class="col-lg-8 mb-2">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        @include('admin.templates.uploaded-images', ['upload_path' => 'goods-pages'])
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-select" name="p_id" id="p_id">
                                                    ...
                                                    {!! SelectTreeGoodsPage($lang_id, 0, $menu_id->p_id) !!}
                                                </select>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select class="form-select" name="goods_subject_id"
                                                        ...
                                                        @foreach($goods_subject_list as $one_goods_subject)
                                                            <option
                                                                value="{{ $one_goods_subject->id ?? '' }}" {{ $one_goods_subject->id == $menu_id->goods_subject_id ? 'selected' : '' }}>{{ $one_goods_subject->itemByLang->name ?? '' }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            @endif
