                            ...
                            <div class="d-lg-flex align-items-center mb-4 gap-3">
                                <div class="ms-auto">
                                    ...
                                    @else
                                        ...
                                        @endif
                                    @endif
                                    @if(!empty($deleted_menu_elems) && count($deleted_menu_elems))
                                        <button class="btn btn-success btn-sm mt-2 mt-lg-0 restore-all-elements"
                                                data-url="{{urlForFunctionLanguage($lang, 'restoremenu/restoreMenu')}}"
                                        ...
                                        @if($groupSubRelations->del_to_rec == 1)
                                            <button class="btn btn-danger btn-sm mt-2 mt-lg-0 destroy-all-elements"
                                                    data-url="{{urlForFunctionLanguage($lang, 'destroymenufromcart/destroyMenuFromCart')}}"
                                                    data-current-url="{{ url()->current() }}" disabled>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover">
                                        ...
                                        @foreach($deleted_menu_elems as $one_menu_element)
                                            <tr id="{{$one_menu_element->goods_page_id}}">
                                                ...
                                                <td class="text-center">
                                                    <input class="form-check-input restore-element" type="checkbox"
                                                           ...
                                                           id="restore-element-{{$one_menu_element->goods_page_id}}">
                                                    <label class="form-check-label"
                                                           for="restore-element-{{$one_menu_element->goods_page_id}}"></label>
                                                </td>
                                                @if($groupSubRelations->del_to_rec == 1)
                                                    <td class="text-center">
