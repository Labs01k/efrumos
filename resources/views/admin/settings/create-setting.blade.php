                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-select" name="set_type" id="set_type">
                                                    <option value="input" selected>{{__('variables.input')}}</option>
                                                    <option value="textarea">{{__('variables.textarea')}}</option>
                                                    {{--<option value="ckeditor">{{__('variables.ckeditor')}}</option>--}}
                                                </select>
                                            </div>
