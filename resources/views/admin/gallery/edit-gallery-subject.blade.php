            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <div class="position-relative">
                            <h5 class="card-title">{{__('variables.edit_element')}} - <span
                                    class="text-primary">"{{$gallery_elems->name ?? '' }}"</span></h5>
                        </div>
                        <div class="ms-auto">
                            ...
                            @if($groupSubRelations->new == 1)
                                @if(request()->segment(5) == '' || request()->segment(4) == 'createGallerySubject')
                                    ...
                                    <a href="{{ urlForFunctionLanguage($lang, Str::slug($gallery_without_lang->name).'/editgallerysubject/'.$gallery_without_lang->gallery_subject_id.'/'.$lang_id) }}"
                                       class="btn btn-primary mt-2 mt-lg-0"><i
                                ...
                                @else
                                    ...
                                    <a href="{{ urlForLanguage($lang, 'editgallerysubject/'.$gallery_without_lang->gallery_subject_id.'/'.$lang_id) }}"
                                       class="btn btn-primary mt-2 mt-lg-0"><i
                                            class="fadeIn animated bx bx-edit"></i>{{ __('variables.edit_element') }}
                                    </a>
                                @endif
                    ...
                    <form class="form" method="POST"
                          action="{{ urlForLanguage($lang, 'savesubject/'.$gallery_without_lang->gallery_subject_id.'/'.$lang_to_edit) }}"
                                        ...
                                        <div class="hide-seo-settings">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="page_title" class="form-control"
                                                       id="page_title" value="{{$gallery_elems->page_title ?? '' }}">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="meta_title" class="form-control"
                                                       id="meta_title" value="{{$gallery_elems->meta_title ?? '' }}">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="meta_keywords" class="form-control"
                                                       id="meta_keywords"
                                                       value="{{$gallery_elems->meta_keywords ?? '' }}">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="meta_description" class="form-control"
                                                       id="meta_description"
                                                       value="{{$gallery_elems->meta_description ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-select" name="p_id" id="p_id">
                                                    <option
                                                        value="0" {{ !is_null($gallery_subject_id) ? (($gallery_subject_id->p_id == 0) ? 'selected' : '') : ''}}>{{__('variables.home')}}</option>
