        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <div class="position-relative">
                            <h5 class="card-title">{{__('variables.edit_element')}} - <span
                                    class="text-primary">"{{ $goods_type ? Str::limit($goods_type->name, 50) : '' }}"</span></h5>
                        </div>
                        <div class="ms-auto">
                            @if($groupSubRelations->new == 1)
                                ...
                                <a href="{{ urlForFunctionLanguage($lang, Str::slug($goods_type_without_lang->name).'/editGoodsType/'.$goods_type_without_lang->goods_type_id.'/'.$lang_id) }}"
                                   class="btn btn-primary mt-2 mt-lg-0"><i
                    ...
                    <form class="form" method="POST" action="{{ urlForLanguage($lang, 'save/'.$goods_type_without_lang->goods_type_id.'/'.$lang_to_edit) }}" id="edit-form"
                                ...
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" value="{{$goods_type->name ?? '' }}">
                                        </div>
