...
return [
    ...
    */
    ...
    'onec' => [
        ...
        // Ни то, ни другое значение 1С явно не подтвердил как факт (сказали
        // «для теста ок, на проде см. выше» про 27416) — это наша лучшая
        // интерпретация их комментариев, а не гарантированный факт.
        // 28045/27119 не используем — нет уверенного критерия, когда именно.
