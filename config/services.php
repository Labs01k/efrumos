...
return [
    ...
    */
    ...
    'onec' => [
        ...
        //   27416 (Client B2C)              — заказы с адресной доставкой (наш курьер)
        ...
        // (Nova Poshta — единственная сторонняя курьерская служба в
        // Orders.delivery_method, см. Rule::in() в OrderController). Сейчас
        // эти два варианта скрыты в чекауте (option закомментирован в
        // checkout-form-items.blade.php), поэтому веткой orders.delivery_method
        // с ними на практике ещё никто не проходил — код готов на случай,
        // если их снова включат в UI.
