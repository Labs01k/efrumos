...
')
     ...
     */
         ...
         * @static
         */
        public static function on($account)
        {
                        /** @var \Webapix\GLS\Laravel\Client $instance */
                        return $instance->on($account);
        }
                    /**
         *
         *
         * @static
         */
        public static function onAccount($account)
        {
                        /** @var \Webapix\GLS\Laravel\Client $instance */
                        return $instance->onAccount($account);
        }
                    /**
         *
         *
...
namespace  {
            ...
            class MyGls extends \Webapix\GLS\Laravel\MyGls {}
